  ...
  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLogin">
    ...
    <div class="container mt-4">
        ...
        <button class="btn btn-primary kategori-button">Sastra</button>
            ...
            <button class="btn btn-secondary dropdown-toggle" type="button" id="lainnyaDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Lainnya
            </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content p-3">
        <div class="modal-header">
          ...
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Tutup" style="font-size: 32px; border: none; background: none;">×</button>
        </div>
